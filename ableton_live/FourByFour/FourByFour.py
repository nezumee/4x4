...
class FourByFour(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for FourByFour in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in FourByFour._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in FourByFour._active_instances:    # Make sure you update the name
            FourByFour._active_instances.append(self)   # Make sure you update the name
            FourByFour._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in FourByFour._active_instances) and FourByFour._active_instances.remove(self):    # Make sure you update the name
